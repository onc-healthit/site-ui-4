...
const ResultsDialog: FC<ResultsDialogProps> = ({ open, handleClose, response, contentDisplay, title }) => {
...
const ResultsComponent = ({
  ...
  const handleLoadingOpen = () => {
    setLoadingOpen(true)
    eventTrack(`Submit ${buttonTitle}`, 'Transport Test Tool', resultsDialogTitle)
  }
