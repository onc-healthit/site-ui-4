...
export default function ValidationResultsSCCVocabularyValidationConformance() {
  return (
    <>
      <Accordion
        sx={{
      ...
      <Box sx={{ marginBottom: 1 }} p={1}>
        This is an example for an edge case: if there no results to be shown add helper text.{' '}
      </Box>
    </>
  )
}
