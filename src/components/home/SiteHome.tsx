  ...
  return (
    <main>
      ...
      <BannerBox
        ...
        heading={'Welcome to the Assistant Secretary for Technology Policy Standards Implementation & Testing Environment (SITE)'}
        subHeading={'The hub for testing tools & resources'}
        isTourButton={true}
        description={
          <>
            SITE is a centralized collection of testing tools and
